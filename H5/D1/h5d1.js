...
var TOP_ARM_HEIGHT = 1.0;
var TOP_ARM_WIDTH = 2.5;
  ...
  window.addEventListener("keydown", function (e) {
    switch (e.keyCode) {
      ...
      case 40: // down arrow
        zDist -= 1.0;
        break;
      case 39: // right arrow (→) - snýr stöpli áfram
        theta[0] = Math.min(180, theta[0] + 5);
        break;
      case 37: // left arrow (←) - snýr stöpli afturábak
        theta[0] = Math.max(-180, theta[0] - 5);
        break;
      case 90: // z - snýr neðri armi
        theta[1] = Math.min(80, theta[1] + 5);
        break;
      case 88: // x - snýr neðri armi
        theta[1] = Math.max(-80, theta[1] - 5);
        break;
      case 65: // a - snýr efri armi
        theta[2] = Math.min(90, theta[2] + 5);
        break;
      case 83: // s - snýr efri armi
        theta[2] = Math.max(-90, theta[2] - 5);
        break;
      case 81: // q - snýr efsta armi
        theta[3] = Math.min(-90, theta[3] - 5);
        break;
      case 87: // w - snýr efsta armi
        theta[3] = Math.min(90, theta[3] + 5);
        break;
    }
  });
...
var render = function () {
  ...
  modelViewMatrix = mult(modelViewMatrix, rotateY(theta[TopArm]));
  topArm();
